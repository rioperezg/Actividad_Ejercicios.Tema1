...
import Formateo
# Aqui se encuentra el menu, donde simplemente pediremos por pantalla que se introduzca el numero del ejercicio que se quiere ejecutar
# Y mediante condicionales, ejecutamos el ejercicio que corresponda
def iniciar():
